...
class TestLFUCache(unittest.TestCase):
    def test_problem_example(self):
        ...
        # Key 2 has frequency 1, while key 1 has frequency 2.
        # Therefore, key 2 should be evicted.
        cache.put(3, 3)

        self.assertEqual(cache.get(2), -1)
        self.assertEqual(cache.get(3), 3)

        # Keys 1 and 3 now have equal frequencies.
        # Key 1 is less recently used, so it should be evicted.
        cache.put(4, 4)
    ...
    def test_update_existing_key(self):
        ...
        # Updating key 1 changes its value and increases its frequency.
        cache.put(1, 100)

        self.assertEqual(cache.get(1), 100)

        # Key 2 has the smaller frequency, so inserting key 3
        # should evict key 2.
        cache.put(3, 30)
    ...
    def test_capacity_one(self):
        ...
        # The cache can only contain one key.
        cache.put(2, 20)
